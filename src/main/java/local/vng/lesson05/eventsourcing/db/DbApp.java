...
import local.vng.lesson05.eventsourcing.message.MQCreatePerson;
import local.vng.lesson05.eventsourcing.message.MQDeletePerson;
import local.vng.lesson05.eventsourcing.message.MqType;
import org.apache.log4j.BasicConfigurator;
import org.springframework.context.annotation.AnnotationConfigApplicationContext;

import static java.util.Objects.nonNull;
import static local.vng.lesson05.eventsourcing.message.MqType.CREATE;
import static local.vng.lesson05.eventsourcing.message.MqType.DELETE;
...
public class DbApp {
    public static void main(String[] args) throws Exception {
        ...
        DbService dbService = applicationContext.getBean(local.vng.lesson05.eventsourcing.db.DbService.class);
